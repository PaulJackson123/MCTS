...
abstract class DCPiece {
	...
	Collection<DCMove> getCandidateMoves(DylaneanChess chess, int player) {
...
//		Collection<DCMove> getCandidateMoves(DylaneanChess chess, int player) {
//			List<DCMove> moves = new ArrayList<>();
//			int canAttack = player == 0 ? 2 : -2;
//			if (file > 0) {
//				addLegalMove(moves, chess, rank, file - 1, canAttack, player);
//			}
//			if (file < 5) {
//				addLegalMove(moves, chess, rank, file + 1, canAttack, player);
//			}
//			if (rank > 0) {
//				addLegalMove(moves, chess, rank - 1, file, canAttack, player);
//				if (file > 0) {
//					addLegalMove(moves, chess, rank - 1, file - 1, canAttack, player);
//				}
//				if (file < 5) {
//					addLegalMove(moves, chess, rank - 1, file + 1, canAttack, player);
//				}
...
//			int canAttack = player == 0 ? 2 : -2;
//			if (file > 0) {
//				if (isLegalMove(chess, rank, file - 1, canAttack, player)) {
//					return true;
//				}
//			}
//			if (file < 5) {
...
//			}
//			if (rank > 0) {
//				if (isLegalMove(chess, rank - 1, file, canAttack, player)) {
//					return true;
//				}
//				if (file > 0) {
//					if (isLegalMove(chess, rank - 1, file - 1, canAttack, player)) {
//						return true;
//					}
//				}
//				if (file < 5) {
...
//
//		@Override
//		boolean hasOpponentInCheck(DylaneanChess chess, int opponent) {
//			int[][] board = chess.getBoard();
//			int king = opponent == 0 ? -4 : 4;
//			if (file > 0) {
//				if (board[rank][file - 1] == king) {
//					return true;
//				}
//			}
//			if (file < 5) {
...
//			}
//			if (rank > 0) {
//				if (board[rank - 1][file] == king) {
//					return true;
//				}
//				if (file > 0) {
//					if (board[rank - 1][file - 1] == king) {
//						return true;
//					}
//				}
//				if (file < 5) {
...
//			List<DCMove> moves = new ArrayList<>();
//			int[][] board = chess.getBoard();
//			int canAttack = player == 0 ? 3 : -3;
//			// Two spaces forward
//			if (player == 1 && file > 1) {
//				if (board[rank][file - 1] == 0) {
//					addLegalMove(moves, chess, rank, file - 2, canAttack, player);
//				}
//			}
//			else if (player == 0 && file < 10) {
//				if (board[rank][file + 1] == 0) {
//					addLegalMove(moves, chess, rank, file + 2, canAttack, player);
//				}
//			}
...
//			if (player == 1 && file > 1) {
//				if (board[rank][file - 1] == 0) {
//					if (isLegalMove(chess, rank, file - 2, canAttack, player)) {
//						return true;
//					}
//				}
//			}
...
//			int king = opponent == 0 ? -4 : 4;
//			// Two spaces forward
//			if (opponent == 0 && file > 1) {
//				if (board[rank][file - 1] == 0) {
//					if (board[rank][file - 2] == king) {
//						return true;
//					}
//				}
//			}
//			else if (opponent == 1 && file < 10) {
//				if (board[rank][file + 1] == 0) {
//					if (board[rank][file + 2] == king) {
//						return true;
//					}
...
//					addLegalMove(moves, chess, rank - 2, file, canAttack, player);
//				}
//			}
//			if (rank < 11) {
//				if (board[rank + 1][file] == 0) {
...
//			if (rank > 1) {
//				if (board[rank - 1][file] == 0) {
//					if (isLegalMove(chess, rank - 2, file, canAttack, player)) {
//						return true;
//					}
//				}
//			}
...
//						addLegalMove(moves, chess, rank - 2, file - 2, canAttack, player);
//					}
//				}
//				if (file < 4) {
//					if (board[rank - 1][file + 1] == 0) {
...
//				}
//			}
//			// Three-space jump. No check for blanks in between.
//			if (rank > 2) {
//				addLegalMove(moves, chess, rank - 3, file, canAttack, player);
//			}
//			if (rank < 9) {
//				addLegalMove(moves, chess, rank + 3, file, canAttack, player);
//			}
...
//				if (file > 1) {
//					if (board[rank - 1][file - 1] == 0) {
//						if (isLegalMove(chess, rank - 2, file - 2, canAttack, player)) {
//							return true;
//						}
//					}
//				}
...
//			// Three-space jump. No check for blanks in between.
//			if (rank > 2) {
//				if (isLegalMove(chess, rank - 3, file, canAttack, player)) {
//					return true;
//				}
//			}
//			if (rank < 9) {
